...
- **สเตจปัจจุบัน: เฟส 4 (System Overhaul) เริ่มแล้ว** สเปกอยู่ที่ `.scratch/outfit-color-matcher/spec.md`
  ...
  - **ค้าง (ตั๋ว 06):** "Swap ทุกการ์ดในแบตช์" ติดข้อขัดแย้งเชิงออกแบบ การ์ดข้างๆ เป็น peek 40-72px +
    `inert`/`aria-hidden` ตั้งแต่เฟส 1 กดไม่ถึงจริง รอผู้ใช้เลือกทางออก (ดูตั๋ว 06)
  - **ยังไม่เริ่ม:** เฟส C (Collage Art Style + เลิก dark mode + ธีมไดนามิก) และเฟส D (modal จัดกลุ่มสี +
    รีดีไซน์ garment tile)
