...
- **[thai-prompt-optimizer](./thai-prompt-optimizer/SKILL.md)**: Turn a Thai request into a clear English instruction for AI, with assumptions and open questions surfaced in Thai rather than guessed. UNVALIDATED: not yet measured against a baseline. User-invoked.
