...
- **[thai-prompt-optimizer](./thai-prompt-optimizer/SKILL.md)**: Turn a Thai request into a clear English instruction for AI, with assumptions and open questions surfaced in Thai rather than guessed. MEASURED, NOT YET SHOWN TO HELP: scores below a plain Thai "ask before acting" instruction on a random sample. User-invoked.
